...
import data from "../testData/paygrade.json";

test("Verify add pay grades with valid inputs", async ({page}) => {
    // Actions
    ...
    await expect (page).toHaveURL("/web/index.php/admin/payGrade/15")
});