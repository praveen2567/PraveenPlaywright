...
test.describe('Automation - Working With Elements', () => {
    ...
    test('Links -example2 ', async ({ page }) => {
        ...
        await expect.soft(page.locator("//a")).toHaveCount(371) //links are developed with anchor tag
        // here i will give the soft assertion even if it fails anythinge execution doesnt stop
